...
//  See "Reboot Using ICAP_SPARTAN6" in ug380.pdf for details

module multiboot (
    input wire clk,   // WARNING: this clock must not be greater than 20MHz (50ns period)
    input wire rst,
    input wire boot,
    input wire [23:0] boot_spi_adr
    );
...
//Q
        ...
        GEN1_L:
            begin
               ...
               icap_ce     = 0;
               icap_wr     = 0;
               icap_din    = boot_spi_adr[15:0]; //16'hC000;   //  dreccion SPI BAJA
            end
        ...
        GEN2_L:
            begin
               ...
               icap_ce     = 0;
               icap_wr     = 0;
               icap_din    = {3'h6B, boot_spi_adr[23:16]}; //  03 lectura SPI opcode + direccion SPI ALTA (03 = 1x, 6B = 4x)
            end
